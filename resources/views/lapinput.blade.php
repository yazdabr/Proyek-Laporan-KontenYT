...
<body class="flex bg-[#EDF2F9]" x-data="layout">
    <aside id="sidebar" x-cloak class="fixed inset-y-0 left-0 z-50 w-64 bg-[#6685A9] text-white flex flex-col transition-transform duration-300 transform lg:translate-x-0 lg:min-h-screen overflow-y-auto" :class="{ 'translate-x-0 ease-out': sidebarOpen, '-translate-x-full ease-in': !sidebarOpen }">
        ...
        <nav class="flex-1 p-4 space-y-2">
            ...
            <a href="/lapinput" class="group flex items-center space-x-2 p-3 rounded bg-[#4F5F7C] hover:bg-[#CCD5E1] transition-all duration-300 ease-in-out text-[#f6f6f6]">
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="bg-white p-4 sm:p-4 rounded-md shadow-lg space-y-6">
                    <h2 class="text-xl font-semibold text-gray-800 border-b pb-3 mb-4 flex items-center space-x-2 text-primary">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.555-4.555A1 1 0 0019 4H5a1 1 0 00-.707 1.707L10 11.414V17a1 1 0 00.5.866l4 2A1 1 0 0016 19v-7a1 1 0 00-1-1z"></path></svg>
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <input type="url" id="link_youtube" class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 focus:border-primary focus:ring-1 focus:ring-primary transition duration-200" placeholder="Contoh: https://youtu.be/..." required>
                        </div>
                        
                        <div>
                            <label for="acara" class="font-semibold mb-2 block text-gray-700">Acara</label>
                            <input type="text" id="acara" class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 focus:border-primary focus:ring-1 focus:ring-primary transition duration-200" placeholder="Masukkan Judul Acara">
                        </div>

                        <div>
                            <label for="topik" class="font-semibold mb-2 block text-gray-700">Topik</label>
                            <input type="text" id="topik" class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 focus:border-primary focus:ring-1 focus:ring-primary transition duration-200" placeholder="Masukkan Judul Topik">
                        </div>

                        <div>
                            <label for="narasumber" class="font-semibold mb-2 block text-gray-700">Narasumber</label>
                            <input type="text" id="narasumber" class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 focus:border-primary focus:ring-1 focus:ring-primary transition duration-200" placeholder="Masukkan Nama Narasumber">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-4 sm:p-4 rounded-md shadow-lg space-y-6 mt-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                <input type="date" id="tanggal_kegiatan" class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 text-gray-600 pr-10 appearance-none bg-white focus:border-primary focus:ring-1 focus:ring-primary transition duration-200" required>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative w-full">
                                <select id="pro_select" class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 text-gray-600 appearance-none bg-white focus:border-primary focus:ring-1 focus:ring-primary transition duration-200" required>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative w-full">
                                <select id="operator_a_select" class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 text-gray-600 appearance-none bg-white focus:border-primary focus:ring-1 focus:ring-primary transition duration-200">
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative w-full">
                                <select id="operator_b_select" class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 text-gray-600 appearance-none bg-white focus:border-primary focus:ring-1 focus:ring-primary transition duration-200">
                         ...
                         <div class="col-span-full"> 
                            ...
                            <input type="text" id="media_input" class="w-full border-2 border-gray-300 rounded-lg px-4 py-3 focus:border-primary focus:ring-1 focus:ring-primary transition duration-200" placeholder="Masukkan Media">
                        </div>
                    </div>
                </div>
                
                <div class="flex justify-end space-x-4 mt-8">
                    <a href="#" class="bg-gray-400 text-white font-semibold px-6 py-3 rounded-md shadow-lg hover:bg-gray-500 transition-colors duration-300">Kembali</a>
                    <button type="submit" class="bg-[#2E4269] text-white font-semibold px-6 py-3 rounded-md shadow-lg hover:bg-[#6685A9] transition-colors duration-300 flex items-center space-x-2">
